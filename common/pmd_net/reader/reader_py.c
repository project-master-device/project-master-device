...
static PyMethodDef pmd_net_reader_methods[] = {
	{"send_msg", pmd_net_reader_write_send_msg_data_py, METH_VARARGS, "(i)pack command: the read code| args: - | return:(rc -int, packed_msg -str)"},
	{"green_led_off", pmd_net_reader_write_green_led_off_data_py, METH_VARARGS, "(o)pack command: turn green led off| args: - | return:(rc -int, packed_msg -str)"},
	{"green_led_on", pmd_net_reader_write_green_led_on_py, METH_VARARGS, "(o)pack command: turn green led on| args: - | return:(rc -int, packed_msg -str)"},
	{"beep_on", pmd_net_reader_write_beep_on_py, METH_VARARGS, "(o)pack command: turn beeper on| args: - | return:(rc -int, packed_msg -str)"},
	{"beep_off", pmd_net_reader_write_beep_off_py, METH_VARARGS, "(o)pack command: turn beeper off| args: - | return:(rc -int, packed_msg -str)"},
//	{"write", pmd_net_reader_write_data_py, METH_VARARGS, "pack command for reader, return:(rc -int, packed_msg -str)"},
	{"read", pmd_net_reader_read_data_py, METH_VARARGS, "unpack command for reader| args: packed_msg -str| return:(rc -int, operation_code -int)"},
