...
static PyMethodDef pmd_net_system_methods[] = {
	...
	{"config_request", pmd_net_sys_config_w_request_py, METH_VARARGS, "(o?)pack command for config: request full config| args: - | return:(rc -int, packed_msg -str)"},
	{"config_full", pmd_net_sys_config_w_full_py, METH_VARARGS, "(i?)pack command for config: write full config| args: config -list| return:(rc -int, packed_msg -str)"},
