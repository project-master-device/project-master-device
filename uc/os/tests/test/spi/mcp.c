...
void mcp_write_frame(uint8_t buf_begin_addr, const can_frame * msg) {
    //mcp_modify_reg(buf_begin_addr - 1, MCP_TXB_TXREQ_MASK, MCP_TXB_TXREQ_NOT_PENDING);
...
//    cfg1 = 0x01; cfg2 = 0xb5; cfg3 = 0x01;
    //250 Kbit/sec agreed with at90can128 settings
    cfg1 = 0x01; cfg2 = 0xac; cfg3 = 0x03;
    //cfg1 = 0x09; cfg2 = 0x91; cfg3 = 0x01;
