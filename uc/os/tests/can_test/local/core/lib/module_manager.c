...
void module_manager_add_option(module_t * module, const char * key, const char * value) {
...
void module_manager_remove_option(module_t * module, const char * key) {
    config_option_t * option;
...
void module_manager_modify_option(module_t * module, const char * key, const char * value) {
    config_option_t * option;
