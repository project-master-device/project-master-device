...
static PyMethodDef pmd_net_button_methods[] = {
	{"down", pmd_net_button_write_down_py, METH_VARARGS, "(i)pack command: button down| args: - | return:(rc -int, packed_msg -str)"},
	{"up", pmd_net_button_write_up_py, METH_VARARGS, "(i)pack command: button up| args: - | return:(rc -int, packed_msg -str)"},
//	{"write", pmd_net_button_write_data_py, METH_VARARGS, "pack command for button| args: ... | return:(rc -int, packed_msg -str)"},
	{"read", pmd_net_button_read_data_py, METH_VARARGS, "unpack command for button| args: packed_msg -str| return:(rc -int, operation_code -int)"},
