...
static PyMethodDef pmd_net_led_methods[] = {
	{"on", pmd_net_led_write_on_py, METH_VARARGS, "(o)pack command: turn LED on| args: - | return:(rc -int, packed_msg -str)"},
	{"off", pmd_net_led_write_off_py, METH_VARARGS, "(o)pack command: turn LED off| args: - | return:(rc -int, packed_msg -str)"},
	{"toggle", pmd_net_led_write_toggle_py, METH_VARARGS, "(o)pack command: toggle LED state| args: - |return:(rc -int, packed_msg -str)"},
//	{"write", pmd_net_led_write_data_py, METH_VARARGS, "pack command for LED, return:(rc -int, packed_msg -str)"},
	{"read", pmd_net_led_read_data_py, METH_VARARGS, "unpack command for LED| args: packed_msg -str| return:(rc -int, operation_code -int)"},
