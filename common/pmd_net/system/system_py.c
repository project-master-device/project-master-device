...
inline static PyObject* call_config_write_py(bytearr_t* arr, pmd_net_sys_config_data_t* data) {
...
static PyObject* pmd_net_sys_config_write_config_request_py(PyObject* self, PyObject* args) {
	...
	return call_config_write_py(arr, &data);
}
...
inline static PyObject* call_config_write_with_section(PyObject* arg, bytearr_t* arr, uint8_t operation) {
	pmd_net_sys_config_data_t data;
...
static PyObject* pmd_net_sys_config_write_config_section_add_py(PyObject* self, PyObject* args) {
	bytearr_t* arr;
	return call_config_write_with_section(args, arr, PMD_NET_SYS_CONFIG_SECTION_ADD)
}
...
static PyMethodDef pmd_net_system_methods[] = {
	{"heartbeat_write", pmd_net_heartbeat_write_data_py, METH_VARARGS, "(i)make data for heartbeat msg, return:(rc -int, packed_msg -str)"},
	{"config_write_request", pmd_net_sys_config_write_config_request_py, METH_VARARGS, "(o?)pack command for config: request full config| args: - | return:(rc -int, packed_msg -str)"},
	{"config_write_full", pmd_net_sys_config_write_config_full_py, METH_VARARGS, "(i?)pack command for config: write full config| args: config -list| return:(rc -int, packed_msg -str)"},
	{"config_write_section_add", pmd_net_sys_config_write_section_add_py, METH_VARARGS, "(o)pack command for config: add config section| args: section -tuple| return:(rc -int, packed_msg -str)"},
	{"config_write_section_del", pmd_net_sys_config_write_section_del_py, METH_VARARGS, "(o)pack command for config: del config section| args: section -tuple| return:(rc -int, packed_msg -str)"},
//	{"config_write", pmd_net_sys_config_write_data_py, METH_VARARGS, "pack command for config, return:(rc -int, packed_msg -str)"},
	{"config_read", pmd_net_sys_config_read_data_py, METH_VARARGS, "unpack command for config| args: packed_msg -str| return:(rc -int, operation_code -int)"},
//	{"set_op_write", pmd_net_sys_set_op_write_data_py, METH_VARARGS, "pack command for set_op, return:(rc -int, packed_msg -str)"},
	{"set_op_read", pmd_net_sys_set_op_read_data_py, METH_VARARGS, "unpack command for set_op| args: packed_msg -str| return:(rc -int, operation_code -int)"},
